...
func init() {
	...
	if authEnabled {
		context.InitAuth()
		beego.Router(fmt.Sprintf("%s/auth/callback", basePath), &controllers.AuthController{}, "get:Callback")
		beego.InsertFilter(fmt.Sprintf("%s/admin/*", basePath), beego.BeforeRouter, filters.AuthFilter)
		beego.InsertFilter(fmt.Sprintf("%s/api/v1/edp/*", basePath), beego.BeforeRouter, filters.AuthRestFilter)
		beego.InsertFilter(fmt.Sprintf("%s/admin/edp/*", basePath), beego.BeforeRouter, filters.RoleAccessControlFilter)
		beego.InsertFilter(fmt.Sprintf("%s/api/v1/edp/*", basePath), beego.BeforeRouter, filters.RoleAccessControlRestFilter)
	} else {
		beego.InsertFilter(fmt.Sprintf("%s/*", basePath), beego.BeforeRouter, filters.StubAuthFilter)
	}
	...
	beego.Router(fmt.Sprintf("%s/", basePath), &controllers.MainController{EDPTenantService: edpService}, "get:Index")
	...
	adminEdpNamespace := beego.NewNamespace(fmt.Sprintf("%s/admin/edp", basePath),
	...
	apiV1EdpNamespace := beego.NewNamespace(fmt.Sprintf("%s/api/v1/edp", basePath),
	...
	apiV1Namespace := beego.NewNamespace(fmt.Sprintf("%s/api/v1", basePath),
