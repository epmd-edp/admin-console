...
func validateAutotestsRequestData(autotests command.CreateCodebase) *helper.ErrMsg {
	...
	if err != nil {
		return &helper.ErrMsg{"An internal error has occurred on server while validating autotests's form fields.", http.StatusInternalServerError}
	}
