$(function () {
    ...
    function getSlaveElement(el) {
        ...
        if ($frameworkVersion.includes("dotnet") && !!$frameworkVersion) {
            return $(`.jenkinsSlave option:contains(${$frameworkVersion})`);
        }
        if ($frameworkVersion.includes("java") && !!$frameworkVersion) {
