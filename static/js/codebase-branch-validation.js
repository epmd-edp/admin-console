$(function () {
    ...
    $('#releaseBranch').change(function () {
        ...
        if ($(this).is(":checked")) {
            ...
            $masterBranchVersionInputEl.attr('disabled', false);
            $masterBranchVersionInputEl.removeClass('hide-element');
        } else {
            ...
            $masterBranchVersionInputEl.attr('disabled', true);
            $masterBranchVersionInputEl.addClass('hide-element');
        }
    });
});
